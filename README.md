...
W plikach pdf znajdują się: dokument wizji systemu oraz 3 specyfikacje przypadków użycia.

## UML (jeden.eapx).

### Model przypadków użycia

![Model przypadków użycia](https://github.com/kcha01/MFIT_APP-UML_Project/blob/master/Screenshots/Model_przypadk%C3%B3w_uzycia.PNG?raw=true)

### Model klas

![Model klas](https://github.com/kcha01/MFIT_APP-UML_Project/blob/master/Screenshots/model_klas.PNG?raw=true)
...
![maszyna stanowa](https://github.com/kcha01/MFIT_APP-UML_Project/blob/master/Screenshots/maszyna_stanowa.PNG?raw=true)

### Model komponentów

![komponentów](https://github.com/kcha01/MFIT_APP-UML_Project/blob/master/Screenshots/model_komponent%C3%B3w.PNG?raw=true)
